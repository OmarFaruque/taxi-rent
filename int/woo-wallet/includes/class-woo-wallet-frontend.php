...
if (!class_exists('Woo_Wallet_Frontend')) {
    ...
    class Woo_Wallet_Frontend {
        ...
        public function __construct() {
            ...
            add_shortcode('tra-wallet', __CLASS__ . '::woo_wallet_shortcode_callback');
            add_shortcode('tra-mini-wallet', __CLASS__ . '::mini_wallet_shortcode_callback');
        ...
        public function woocommerce_endpoint_title($title, $endpoint) {
            switch ($endpoint) {
                case 'woo-wallet' :
                    $title = apply_filters('woo_wallet_account_menu_title', __('My o Wallet', 'woo-wallet'));
                    break;
        ...
        public function woo_wallet_styles() {
            ...
            wp_register_style('woo-wallet-style', woo_wallet()->plugin_url() . '/inc/woo-wallet/assets/css/frontend.css', array(), WOO_WALLET_PLUGIN_VERSION);
            // Add RTL support
            ...
            wp_register_script('wc-endpoint-wallet', woo_wallet()->plugin_url() . '/inc/woo-wallet/assets/js/frontend/wc-endpoint-wallet' . $suffix . '.js', array('jquery', 'jquery-datatables-script'), WOO_WALLET_PLUGIN_VERSION);
        ...
        public function woo_wallet_menu_items($items) {
            ...
            $items['woo-wallet'] = apply_filters('woo_wallet_account_menu_title', __('My Wallet 9', 'woo-wallet'));
        ...
        */
        public function get_user_id_by_sk($sk){
            $user = get_users(
                array(
        ...
        public function do_wallet_transfer() {
            ...
            if (isset($_POST['woo_wallet_transfer']) && wp_verify_nonce($_POST['woo_wallet_transfer'], 'woo_wallet_transfer')) {
                ...
                if(isset($_POST['user_sk'])){
                    $whom = $this->get_user_id_by_sk($_POST['user_sk']);
                }
