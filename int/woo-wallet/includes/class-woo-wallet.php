...
final class WooWallet {
    ...
    private function define_constants(){
        $this->define( 'WOO_WALLET_ABSPATH', teraWalletDIR . 'inc/woo-wallet/' );
    ...
    private function init_hooks() {
        // echo 'activation file: ' . WOO_WALLET_PLUGIN_FILE . '<br/>'; 
        ...
        // add_action( 'wp_loaded', array( $this, 'woocommerce_loaded_callback' ) );
    ...
    public function init() {
        ...
        // echo 'init omar om <br/>';
        foreach ( apply_filters( 'wallet_credit_purchase_order_status', array( 'completed' ) ) as $status) {
            // echo 'inside filter '.$status.' <br/>';
