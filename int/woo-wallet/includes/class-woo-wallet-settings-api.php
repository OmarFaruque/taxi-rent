...
if ( ! class_exists( 'Woo_Wallet_Settings_API' ) ):
    ...
    class Woo_Wallet_Settings_API {
        ...
        * Labelonly callback
        */
        function callback_labelonly($args){
            ob_start();
            echo $args['std'];
        ...
        * ImportExport
        */
        function callback_importexport($args){    
            ob_start(); ?>
            <div id="downloadcsv">
                <a download href="<?php echo teraWalletURL . 'asset/csv/demo-trawallet.csv'; ?>">
        ...
        * function upload
        */
        public function callback_uploadata(){
            ob_start(); ?>
            <div id="uploadcsv">
                <div class="uploadform form-group">
        ...
        * Create button 
        */
        public function callback_createbutton(){
            ob_start(); ?>
            <div id="createbutton">
                <div class="errormsg"></div>
                <div class="createbuttonForm form-group">
                        <button class="mb-1 button button-primary" id="createform"><?php _e('Create', 'trawallet'); ?></button>
                        <textarea data-url="<?php echo get_home_url('/'); ?>" name="trawallet_transation" id="transation" style="width:100%" rows="10"></textarea>
                </div>
            </div>
            <?php
            $html = ob_get_clean();
         ...
         *
         * Usually this should be called at `admin_init` hook. 01781255993
         *
